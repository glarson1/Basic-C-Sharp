    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (string item in stringList)
            {
                ...
                else if (userEntry != item)
                {
                    Console.WriteLine("Sorry that input is not on the list");
                }
                else
                {
            ...
            //a way to get the index of a list item
            int y = listOfStrings.IndexOf(userSearch);
            //iteration
            foreach (string item in listOfStrings)
            {
                //this determines if the search matches up or not
                if (userSearch == item)
                {
                    Console.WriteLine("the index(s) of that input is " + y);

                }
                else if (userSearch != item)
                {
                    Console.WriteLine("Sorry that input is not on the list");
                }
                else
